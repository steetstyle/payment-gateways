import { CardType, ClientLang, Currency, DebugMode, Instalment, Non3DMode, Non3DTestFailedMode, PaymentType, RecurringMode, SyncMode, TestMode } from '../common'
...
export interface Body {
	 ...
	 * Daha fazla bilgi için dokümantasyonu okuyunuz. */
	store_card: '1';
	...
	/** Kart güvenlik kodu. */
	cvv: string;
	/** Kart tipi (Taksitli işlemlerde kullanmak üzere).  advantage, axess, combo, bonus, cardfinans, maximum, paraf, world, saglamkart. */
	card_type?: CardType;
}
